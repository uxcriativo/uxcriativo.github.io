 ...
 * @version   3.0
 */
class UX_Parser extends CI_Parser {
    ...
    */
    ...
    public function set_theme($name) {
        ...
        $functions_file3 = APPPATH."../".$this->CI->config->item('smarty.theme_path') . $this->_theme_name . '/plugins/functions.php';
        ...
        elseif ( file_exists($functions_file3) ) {
        	include_once($functions_file3);
        }
        // Update theme paths
        $this->_update_theme_paths();
    }
        ...
        if ( $current_module !== $this->_module ) {
            $new_locations = array(
                ...
                $this->CI->config->item('smarty.theme_path') . $this->_theme_name . '/views/modules/' . $current_module .'/',
           		APPPATH . '../'.$this->CI->config->item('smarty.theme_path') . $this->_theme_name . '/',
