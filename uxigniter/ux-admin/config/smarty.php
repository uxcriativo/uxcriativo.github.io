...
$config['smarty.theme_path'] = 'ux-content/themes/';
...
$config['smarty.compile_directory'] = UXINCLUDES."cache/smarty/compiled/";

// Where templates are cached
$config['smarty.cache_directory'] = UXINCLUDES."cache/smarty/cached/";

// Where Smarty configs are located
$config['smarty.config_directory'] = UXINCLUDES."third_party/Smarty/configs/";
